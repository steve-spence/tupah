...
export function LeftNav({ data, className, onNavigate }: Props) {
    ...
    return (
        <div className={`${className} h-full flex flex-col justify-between items-center py-5`}>
            ...
            <NavIcon data={{ id: "nav_settings", title: "Mode", bg_path: "/icons/theme.svg", link: "" }} onClick={() => setTheme("dark")} />
        </div>
    );
}
