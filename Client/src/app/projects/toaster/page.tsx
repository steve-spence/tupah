...
export default function ToasterPage() {
    ...
    useEffect(() => {
        var interval = Math.floor(Math.random());
    ...
    return (
        <div className="flex flex-col items-center justify-center bg-white dark:bg-[#212121]">
            <h1 className="text-4xl text-black dark:text-white p-10 bg-gray-400 w-full text-center font-bold">Click when the toast comes up!</h1>
