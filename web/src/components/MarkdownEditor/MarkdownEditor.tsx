...
export default function MarkdownEditor({
    ...
    const runToolbarAction = useCallback((id: string) => {
        switch (id) {
            case "bold": return insertFormatting("**");
            case "italic": return insertFormatting("*");
            case "heading": return insertFormatting("## ", "");
            case "link": return insertFormatting("[", "](url)");
            case "image": return setShowImagePicker(true);
            case "code": return insertFormatting("`");
            case "list": return insertFormatting("- ", "");
            case "quote": return insertFormatting("> ", "");
        }
    }, [insertFormatting]);
    ...
    return (
        <div>
            ...
            <div className="flex gap-1 p-2 bg-gray-100 dark:bg-[#252525] rounded-t-lg border-2 border-b-0 border-gray-300 dark:border-gray-600">
                {toolbarButtons.map(({ id, icon: Icon, title }) => (
